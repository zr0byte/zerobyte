    ...
    <div className='z-20 flex lg:flex-row sm:flex-col lg:justify-between md:justify-center items-center my-auto min-w-96 lg:mx-40 2xl:mx-64 mx-6 text-left h-auto'>
      ...
      <div className='lg:justify-start md:text-center'>
        <div className="lg:justify-start md:justify-center items-center justify-center md:w-auto sm:w-auto">
          <div className="lg:text-7xl text-5xl md:text-6xl mx-auto font-bold text-neutral-600 dark:text-neutral-400 md:text-center text-center lg:text-left">
            <div className='flex flex-wrap lg:justify-start justify-center md:justify-center'>
              Unlock
        ...
        <h3 className='lg:text-4xl lg:text-left md:text-center sm:text-center text-base text-center md:text-3xl text-black sm:w-full font-bold dark:text-[#4379F2]w-max bg-clip-text bg-no-repeat text-transparent bg-gradient-to-r py-4 from-purple-500 via-violet-500 to-pink-500 '>Conduct private transactions on the blockchain with zero-knowledge proofs.</h3>
        <div className=' text-neutral-600 dark:text-neutral-400 mb-5 sm:w-full lg:text-left text-center md:text-center'>
