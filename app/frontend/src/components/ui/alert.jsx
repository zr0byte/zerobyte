  ...
  "relative w-full rounded-lg border border-neutral-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-neutral-950 dark:border-neutral-800 dark:[&>svg]:text-neutral-50",
  {
    variants: {
      variant: {
        ...
        warning: "border-yellow-400 text-yellow-700 dark:border-yellow-700 dark:text-yellow-400 " +
          "dark:border-yellow-900/50 dark:[&>svg]:text-yellow-400 border-opacity-50 " +
          "[&>svg]:text-yellow-700",
      },
    },
    defaultVariants: {
